-- TEMPORARY DEV ONLY: remove secret handling from V1 checklist import RPC.
-- Purpose: Supabase blocks setting app.v1_checklist_import_key in this project.
-- This keeps the bypass limited to audit_checklist_master through one
-- SECURITY DEFINER RPC. It does not add public insert/update policies and does
-- not affect other tables. Remove after Supabase Auth is implemented.
